...
footer.footer.container
  nav.nav
    p.nav-left
      ...
      a.icon(target="_blank" href="//github.com/sricor")
  ...
  .colophon
    p Crafted using
      a(href="//jenil.github.io/chota/" target="_blank")
        | Chota
      | ,
      a(href="//vuejs.org/" target="_blank")
        | Vue.js
      | ,
      a(href="//nuxtjs.org" target="_blank")
        | TypeScript
      | ,
      a(href="//simpleicons.org" target="_blank")
        | Simple Icons
      | and
      a(href="https://code.visualstudio.com/" target="_blank")
        | Visual Studio Code
      | . Typeface is
      a(href="//rsms.me/inter/" target="_blank")
        | Inter UI
      | .
    p Sricor © 2020 - {{ new Date().getFullYear() }} 粤ICP备2021126496号
</template>
