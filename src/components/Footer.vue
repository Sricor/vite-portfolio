...
<footer class="footer container">
  <nav class="nav">
    <p class="nav-left">
      ...
      <a class="icon" target="_blank" href="">
        ...
        <a class="icon" target="_blank" href="https://github.com/sricor">
        ...
        <a class="icon" target="_blank" href="mailto:josricor@outlook.com">
          <svg aria-labelledby="simpleicons-medium-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="20" fill="fill">
  ...
  <div class="colophon">
    <p>Crafted using 
      ...
      <a href="https://nuxtjs.org/" target="_blank"> Vite.js </a>,
      <a href="https://simpleicons.org/" target="_blank"> Simple Icons </a>
    </p>
    <p>Sricor © 2020 - {{ new Date().getFullYear() }} 粤ICP备2021126496号</p>
  </div>
</footer>
</template>
