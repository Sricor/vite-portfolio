...
.info[data-v-2b7bd773] {
  font-weight: 300;
  color: #9aabb1;
  margin: 0
}

.button[data-v-2b7bd773] {
  margin-top: 50px
}
...
.inFadeOutBottom-enter-active {
  animation: fadeIn .3s
}

.inFadeOutBottom-leave-active {
  animation: moveToBottom .3s
}

.inBottomOutfade-enter-active {
  animation: moveFromBottom .3s
}

.inBottomOutfade-leave-active {
...
.card_OF-oQ {
  padding: 0;
  background-color: transparent;
  transition: all .2s ease, transform .2s cubic-bezier(.03, .98, .52, .99);
...
.card_OF-oQ h4 {
  ...
  color: #fff;
  font-weight: 400;
  text-shadow: 0 1px 8px rgba(0, 0, 0, .4), 0 0 40px #000
}
...
.card_OF-oQ p {
  color: #eee;
  text-shadow: 0 1px 8px rgba(0, 0, 0, .4), 0 0 20px rgba(0, 0, 0, .4);
  width: 100%;
  margin-bottom: 0
}
...
.card_OF-oQ small {
  ...
  color: #eee;
  font-weight: 700;
  text-shadow: 0 0 3px rgba(0, 0, 0, .3), 0 1px 40px #000
}

.card_OF-oQ.black_bL7At h4 {
  color: #000;
  text-shadow: 0 1px 2px rgba(0, 0, 0, .3), 0 1px 40px rgba(0, 0, 0, .4)
}

.card_OF-oQ.black_bL7At small {
  color: #333;
  text-shadow: 0 1px 2px transparent, 0 1px 40px rgba(0, 0, 0, .4)
}

.card_OF-oQ.black_bL7At p {
  color: #222;
